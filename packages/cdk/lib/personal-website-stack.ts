...
export class PersonalWebsiteStack extends Stack {
    constructor(scope: App, id: string, props?: StackProps) {
        ...
        new StaticWebsite(this, 'StaticWebsite', {websiteDomainName: 'brianhandy.io', websiteArtifactCopyConfiguration: new CodebuildWebsiteArtifactConfiguration(this, 'personal-website/build/')})
    }
}